...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "Ther sender is not the contract owner");
        _;
    }
...
contract ERC721MintableComplete is ERC721Metadata("CapstoneProduct", "TEST", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
